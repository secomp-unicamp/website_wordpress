									...
									<header class="article-header">
										<div class="destaque-wrapper">
											...
											<div class="destaque destaque-960">
												...
												<?php
													printf(__('<time class="updated" datetime="%1$s" pubdate>%2$s</time> - Por <span class="vcard author">%3$s</span>.', 'bonestheme'), get_the_time('Y-m-j'), get_the_time(get_option('date_format')), bones_get_the_author_posts_link());
												?></p>
